...
export SCORE_DEFINES = SCORE_USE_STDINT SCORE_UTILS SCORE_TYPES SCORE_ENABLE_ASSERTS SCORE_CONSOLE SCORE_HTTP SCORE_LINKED_LIST SCORE_STRING SCORE_BUFFER SCORE_JSON SCORE_JSON_CJSON
